                        ...
                        with open(filepath + files1, 'r') as f:
                            ...
                            for rows1 in reader:
                                ...
                                if ".php" in rows[8]:
                                    ...
                                    continue
                                sql="INSERT INTO au_custom (`domain`,`ip`,`date`,`url`,`url_status`,`date_time`) VALUES (%s,%s,%s,%s,%s,%s) "
                                val = (rows[0].replace('"', ''), rows[1].replace('"', ''),date_object,rows[8].replace('"', ''),rows[9].replace('"', ''),date_row)
                                ...
                                """val = (
                                    ...
                                    rows[3].replace('"', ''),
                                    rows[
                                        4].replace('"', ''), rows[5].replace('"', ''), date_object,
                                    rows[7].replace('"', ''), rows[
